const REPORT_LOGIC = {
  AIusage: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Audit your 'AI-Dependency'—ensure you still maintain your own problem-solving muscles.",
          "Explore niche AI tools beyond just the big names.",
        ],
        watchMid: [
          "Experiment with using AI for one lifestyle task (meal planning/travel) this week.",
          "Set up a shortcut for your favorite AI tool on your phone home screen.",
        ],
        watchLow: [
          "Start small: ask a chatbot to draft one difficult email today.",
          "Check if your existing phone apps have AI features you've been ignoring.",
        ],
      },
      {
        ...
        watchHigh: [
          "Keep up with the 'Agentic AI' shift—the next wave of AI that takes actions on your behalf.",
          "Teach a peer about AI hallucinations to solidify your knowledge.",
        ],
        watchMid: [
          "Read one article on 'Data Privacy in Generative AI'.",
          "Practice identifying the 'cutoff date' of the specific model you use.",
        ],
        watchLow: [
          "Remind yourself: AI is a prediction engine, not a fact-checker.",
          "Never put personal passwords or financial data into a public AI prompt.",
        ],
      },
      {
        ...
        watchHigh: [
          "Try 'Few-Shot Prompting'—giving the AI 3 examples of the style you want before asking for the result.",
          "Learn how to use AI System Instructions for permanent personas.",
        ],
        watchMid: [
          "The next time AI gives you a 'good' answer, ask: 'How can we make this 20% better?'",
          "Experiment with uploading a document or image to see how the AI processes multi-modal data.",
        ],
        watchLow: [
          "Use the 'Act as a...' framework in your next prompt (e.g., 'Act as a career coach').",
          "Always ask a follow-up question to see how the AI adjusts its logic.",
        ],
      },
      {
        ...
        watchHigh: [
          "Monitor your 'Creative Voice'—ensure the AI isn't flattening your unique style.",
          "Advocate for ethical AI usage within your community.",
        ],
        watchMid: [
          "For any fact-based task, use the 'Two-Source' rule: verify AI data with a primary source.",
          "Identify one bias you've noticed in an AI response recently.",
        ],
        watchLow: [
          "Commit to never using 'Copy-Paste' for AI content; always rewrite it in your own voice.",
          "Acknowledge that AI can be wrong—it is a tool, not an authority.",
        ],
      },
      {
        ...
        watchHigh: [
          "Start a weekly AI experiment: try one tool that is completely outside your comfort zone.",
          "Think about how you can use AI to solve a community or social problem.",
        ],
        watchMid: [
          "Block 30 minutes a week to watch a tutorial on a new AI feature.",
          "Identify one repetitive task you hate and find an AI to automate it.",
        ],
        watchLow: [
          "Reframe AI: it isn't here to replace you, but to replace the 'boring' parts of your day.",
          "Talk to an AI-Native about how they've simplified their workflow.",
        ],
      },
    ];
    ...
    const sectionScores = sectionDefs.map((sec) => {
      ...
      const raw = sectionAnswers.reduce(
        (sum, a) => sum + (a !== null ? 4 - a : 0),
        0,
      );
    ...
    if (overall >= 85) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You are operating at the leading edge of the AI transition. You have successfully integrated AI into your life as a cognitive partner while maintaining a high level of critical and ethical awareness.";
    } else if (overall >= 40) {
      overallLabel = "Strategic Adopter";
      overallColor = "#f59e0b";
      overallDescription =
        "You have a solid foundation and use AI effectively for specific tasks. Your path forward involves moving from 'task-based' usage to 'workflow integration'.";
    } else {
      overallLabel = "AI Traditionalist";
      overallColor = "#6366f1";
      overallDescription =
        "You prefer manual, human-only workflows. While this protects your traditional skills, you are at risk of a 'bandwidth gap' as the world moves toward AI-powered efficiency.";
    }
    ...
    const sectionResults = sectionDefs.map((sec, i) => {
      ...
      return {
        ...
        score,
        color,
        description: sec.descriptions[tier],
        watch: sec[watchKey],
      };
    });
  ...
  disc: (answers) => {
    ...
    answers.forEach((a, i) => {
      if (map[i] && map[i][a] !== undefined) counts[map[i][a]]++;
    });
    ...
    const profiles = {
      D: {
        ...
        color: "#ef4444",
        description:
          "You are a natural results-driver. You move fast, think big, and aren't afraid to challenge the status quo. Your directness is a strength in high-stakes situations, but can create friction when others need more time to process.",
        strengths: [
          "Decisive under pressure",
          "Natural leader in a crisis",
          "Clear and direct communicator",
          "High achievement drive",
        ],
        watch: [
          "Can rush decisions without full information",
          "May steamroll more reserved team members",
          "Impatience with slow processes",
        ],
      },
      I: {
        label: "Influential Connector",
        score: 78,
        color: "#f59e0b",
        description:
          "You are a natural energizer. People gravitate toward your enthusiasm and ideas. You thrive in collaborative, people-facing roles and are at your best when you can inspire and persuade.",
        strengths: [
        ...
        watch: [
          "May overpromise and underdeliver on details",
          "Can avoid difficult, necessary conversations",
          "Loses interest with repetitive tasks",
        ],
      },
      S: {
        ...
        color: "#10b981",
        description:
          "You are the backbone of any high-performing team. You create psychological safety, build loyalty, and ensure consistency. You are at your best when supporting meaningful work in a stable, trusted environment.",
        strengths: [
        ...
        watch: [
          ...
          "Struggles to assert views in group settings",
        ],
      },
      C: {
        label: "Conscientious Analyst",
        score: 79,
        color: "#6366f1",
        description:
          "You are the quality control system of any team. You think before you speak, verify before you commit, and your work reflects a standard of accuracy others struggle to match.",
        strengths: [
          "Exceptional attention to detail",
          "Thorough and systematic thinker",
          "High personal quality standards",
          "Excellent risk assessment",
        ],
        watch: [
          "Can get paralyzed by over-analysis",
          "May be perceived as cold or aloof",
          "Perfectionism can slow execution",
        ],
      },
    };
  ...
  bigfive: (answers) => {
    ...
    if (pct >= 65)
      return {
        label: "High Openness / Extraverted",
        score: pct,
        color: "#a855f7",
        description:
          "Your Big Five profile shows high openness and extraversion. You thrive in dynamic, novel environments and bring creative energy to teams.",
        strengths: [
        ...
        watch: [
          "May lose focus when bored",
          "Can overlook detail in favor of big picture",
          "Takes on too many new things simultaneously",
        ],
      };
    if (pct >= 40)
      return {
        ...
        color: "#6366f1",
        description:
          "Your Big Five profile is well-balanced. You adapt to different environments and can flex between detail-focus and big-picture thinking.",
        strengths: [
          "Versatile across contexts",
          "Manages stress well",
          "Works effectively alone or in teams",
          "Steady under ambiguity",
        ],
        watch: [
          "Can seem inconsistent to others",
          "May not stand out in any single dimension",
          "Needs clear role definition to thrive",
        ],
      };
    return {
      label: "Introverted Analyst",
      score: pct,
      color: "#0ea5e9",
      description:
        "Your Big Five profile shows high conscientiousness and introversion. You do your best work in structured, focused environments where quality matters.",
      strengths: [
        "Deep, focused thinker",
        "High accuracy and reliability",
        "Disciplined self-manager",
        "Excellent solo performer",
      ],
      watch: [
        "Can be drained by excessive social demands",
        "May appear reserved in group settings",
        "Needs time to process before deciding",
      ],
    };
  },
  ...
  MartyrIndex: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Practice 'the 5-second pause' before saying yes to a new request",
          "Identify one task this week that you will intentionally let fail if the owner doesn't step up",
        ],
        watchMid: [
          "Ask yourself: 'Is my help empowering this person or making them dependent on me?'",
          "Set a hard stop time for work 2 days a week",
        ],
        watchLow: [
          "Ensure your 'no' is paired with a clear explanation so you aren't seen as unhelpful",
          "Keep monitoring your capacity as you take on more senior roles",
        ],
      },
      {
        ...
        watchHigh: [
          "Delegate a task that 'only you can do' to a team member this week as a training exercise",
          "Accept that 80% quality from someone else is often better than 100% quality at the cost of your burnout",
        ],
        watchMid: [
          "Stop 'fixing' work. Provide feedback and let the owner redo the task themselves",
          "Create a basic SOP for your most repetitive task",
        ],
        watchLow: [
          "Don't delegate and disappear; ensure you have a light-touch check-in system",
          "Look for more 'stretch assignments' to give your high-performers",
        ],
      },
      {
        ...
        watchHigh: [
          "Audit your calendar: color-code 'deep strategic work' vs 'reactive fire-fighting'",
          "Stop attending meetings where you are not a primary decision-maker",
        ],
        watchMid: [
          "Spend the first 15 minutes of every day defining your 'One Big Win' for the day",
          "Review your project list and delete the bottom 10%",
        ],
        watchLow: [
          "Be careful of 'success guilt'—just because you've become efficient doesn't mean you aren't working hard enough",
          "Teach your prioritization system to your direct reports",
        ],
      },
      {
        ...
        watchHigh: [
          "Delete work messaging apps from your phone for the weekend",
          "Practice saying 'I can help with that, but not until Tuesday'",
        ],
        watchMid: [
          "Create a physical 'shutdown ritual' to signal to your brain that work is over",
          "Stop responding to non-emergency emails after 7 PM",
        ],
        watchLow: [
          "Communicate your boundary philosophy to your team so they feel safe doing the same",
          "Watch for 'boundary creep' during high-stress seasons",
        ],
      },
    ];
    ...
    if (overall >= 65) {
      ...
      overallColor = "#ef4444";
      overallDescription =
        "You are currently stuck in a martyr cycle. You are over-investing in effort while under-investing in leverage. This pattern is unsustainable and is likely preventing you from reaching the next level of leadership because you are too busy doing the work to lead it.";
    } else if (overall >= 35) {
      overallLabel = "Moderate Martyr Tendencies";
      overallColor = "#f59e0b";
      overallDescription =
        "You have solid output, but you frequently fall into the trap of 'suffering productively.' You take on too much and delegate too little, leading to uneven results and occasional exhaustion.";
    } else {
      overallLabel = "High-Leverage Operator";
      overallColor = "#10b981";
      overallDescription =
        "You have successfully decoupled your effort from your impact. You work with a high degree of leverage, protect your boundaries, and ensure your energy is focused where it creates the most systemic value.";
    }
  ...
  SignalNoise: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Don't let your 'depth' become an echo chamber; seek out one high-quality dissenting view weekly",
          "Try teaching what you learn to solidify the signal",
        ],
        watchMid: [
          "Unsubscribe from 5 newsletters today that you haven't read in a month",
          "Set a 20-minute timer for news/social consumption",
        ],
        watchLow: [
          "Switch from 'feeds' to 'folders'—save articles to read later instead of scrolling live",
          "Commit to one long-form book per month",
        ],
      },
      {
        ...
        watchHigh: [
          "Be careful not to become 'unreachable' to the point of causing friction for your team",
          "Schedule your most creative work for your peak biological energy hours",
        ],
        watchMid: [
          "Use a physical signal (like headphones) to tell others you are in deep work",
          "Close all browser tabs that aren't related to your current task",
        ],
        watchLow: [
          "Download a focus app to lock your distracting sites for 60 minutes",
          "Physically move your phone to a different room during deep work",
        ],
      },
      {
        ...
        watchHigh: [
          "Audit your 'Auto-check' habits—are you checking email just because you're bored?",
          "Refine your 'Do Not Disturb' settings for specific high-priority people",
        ],
        watchMid: [
          "Turn off all 'badge' icons (the red dots) on your apps",
          "Establish a 'no-screens' hour before bed",
        ],
        watchLow: [
          "Turn off 100% of non-human notifications today",
      ...
      },
      {
        ...
        watchHigh: [
          "Periodically challenge your own filters—are you missing new 'weak signals' that could be important?",
          "Help your team develop their own filters by being clear about what NOT to work on",
        ],
        watchMid: [
          "Use the Eisenhower Matrix to categorize your to-do list for tomorrow",
          "Practice saying 'That sounds interesting, but it's not a priority for me right now'",
        ],
        watchLow: [
          "Spend 10 minutes every morning identifying the *one* task that makes everything else easier",
          "Stop attending meetings that don't have a clear agenda",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You possess the superpower of the 21st century: the ability to protect your attention. You filter noise ruthlessly and invest your mental energy into high-leverage information and deep work. This allows you to see patterns that others miss.";
    } else if (overall >= 45) {
      overallLabel = "Noise-Sensitive Operator";
      overallColor = "#f59e0b";
      overallDescription =
        "You are aware of the noise, but you haven't yet built the systems to fully escape it. You are productive, but you are likely leaving 30-40% of your mental capacity on the table due to fragmentation and reactive consumption.";
    } else {
      overallLabel = "Information Overloaded";
      overallColor = "#ef4444";
      overallDescription =
        "You are currently drowning in noise. Your attention is being sold to the highest bidder by your apps and notifications. This is likely leading to high stress, low creativity, and a feeling of 'running in place.'";
    }
  ...
  hardworking: (ans) => {
    ...
    return {
      overall,
      overallLabel: "High Output",
      overallColor: "#10b981",
      overallDescription: "Depth and quality of effort.",
  ...
  EmotionalIntelligence: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Don't let self-awareness turn into over-thinking; use the data to act, not just reflect",
          "Help others build awareness by modeling vulnerability",
        ],
        watchMid: [
          "Practice 'Labeling'—when you feel a spike of emotion, name it: 'I am feeling defensive right now'",
          "Ask a trusted peer for 'blind spot' feedback",
        ],
        watchLow: [
          "Start a 2-minute daily journaling habit focusing only on your mood",
          "Pay attention to physical signals: tight chest, clenched jaw—these are emotional data points",
        ],
      },
      {
        ...
        watchHigh: [
          "Make sure you aren't just 'suppressing' emotions—regulation is about processing, not hiding",
          "Practice 'Cognitive Reappraisal'—find the hidden opportunity in a setback",
        ],
        watchMid: [
          "Wait 10 minutes before sending that 'sharp' email",
          "Practice box-breathing (4s in, 4s hold, 4s out, 4s hold) during tense meetings",
        ],
        watchLow: [
          "Count to 10 before responding to a criticism",
          "Identify your 'exit'—when you feel too triggered to think, ask for a 5-minute break",
        ],
      },
      {
        ...
        watchHigh: [
          "Watch for 'empathy fatigue'—protect your own energy while supporting others",
          "Ensure you don't use your 'reading' of people to manipulate situations",
        ],
        watchMid: [
          "Ask 'How does this feel for you?' during project updates",
          "Practice active listening: repeat back what you heard before you respond",
        ],
        watchLow: [
          "Practice 'Perspective Taking'—literally write down the 3 things your 'opponent' might be feeling",
          "Notice body language: are people leaning in or crossing their arms?",
        ],
      },
      {
        ...
        watchHigh: [
          "Be careful of becoming the 'professional mediator'—ensure you aren't solving everyone's problems for them",
          "Use your influence to amplify quieter voices in the room",
        ],
        watchMid: [
          "Identify one 'difficult' conversation you've been avoiding and have it this week",
          "Focus on building rapport with one person outside your direct department",
        ],
        watchLow: [
          "Study basic negotiation tactics—focus on 'interests' instead of 'positions'",
          "Practice 'acknowledgment'—tell someone specifically what you value about their work once a day",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "Your emotional intelligence is a top-tier asset. You navigate the 'human' side of work with a sophistication that allows you to lead through trust and influence. This is the ultimate multiplier for your technical skills.";
    } else if (overall >= 45) {
      overallLabel = "Emotionally Intelligent (Developing)";
      overallColor = "#f59e0b";
      overallDescription =
        "You have a solid foundation, but your EQ can be 'situational.' You are likely great when things are calm, but you lose your emotional edge when the pressure is high. Focused practice on regulation and empathy will unlock your next level.";
    } else {
      overallLabel = "EQ Growth Opportunity";
      overallColor = "#ef4444";
      overallDescription =
        "Your EQ profile suggests you are operating with a 'technical-only' lens. While your skills may be high, your ability to navigate people and your own stress is likely limiting your impact. The good news: EQ is a skill that can be built through intentional practice.";
    }
  ...
  GrowthMindset: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Ensure you aren't taking on *too many* challenges at once—growth requires focus, not just bravery",
          "Help your team embrace challenges by lowering the 'cost of failure'",
        ],
        watchMid: [
          "Choose one task this week that you have *no idea* how to do and commit to it",
          "Reframe 'This is hard' as 'This is new'",
        ],
        watchLow: [
          "Start with 'micro-challenges'—tiny new tasks that only take 10 minutes",
          "Acknowledge that staying in your comfort zone is actually a long-term risk to your career",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't become 'numb' to failure—ensure you are actually extracting the lesson, not just moving on",
          "Share your 'Failure Resume' with your team to build a growth culture",
        ],
        watchMid: [
          "Practice the 'Not Yet' reframe: 'I didn't succeed *yet*'",
          "Set a 15-minute timer for 'venting' after a failure, then pivot immediately to 'solutions'",
        ],
        watchLow: [
          "Look at a past failure from 2 years ago—what did it actually teach you that made you better?",
          "Separate your identity from your results—you are not your mistake",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't mistake 'effort' for 'brute force'—ensure you are working hard *on the right things*",
          "Focus on 'Deliberate Practice'—targeting the specific part of a skill you are worst at",
        ],
        watchMid: [
          "Identify one skill you used to be bad at but are now good at—remind yourself of that process",
          "Value the 'work' as much as the 'win'",
        ],
        watchLow: [
          "Read about 'Neuroplasticity'—your brain literally changes shape as you learn",
          "Stop saying 'I'm not a [Math/Writing/Tech] person'",
        ],
      },
      {
        ...
        watchHigh: [
          "Be careful of 'Feedback Overload'—you don't have to act on every single piece of advice you receive",
          "Seek out 'extreme' feedback from people who will be brutally honest",
        ],
        watchMid: [
          "Ask for 'advice' instead of 'feedback'—it feels less like a judgment and more like a collaboration",
          "Take a breath and count to 5 before responding to a critique",
        ],
        watchLow: [
          "Ask one person today: 'What is one thing I could do 10% better?'",
          "Recognize that people who give you hard feedback are usually the ones who care most about your success",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You have a powerful psychological engine. You view your entire life and career as an experiment in progress. This makes you incredibly resilient and ensures that your potential is constantly expanding.";
    } else if (overall >= 45) {
      overallLabel = "Mixed Mindset (Context-Dependent)";
      overallColor = "#f59e0b";
      overallDescription =
        "You have growth patterns, but they are fragile. You lean into growth when you feel confident, but you revert to 'fixed' thinking (avoiding challenge, fearing failure) when you feel insecure or exposed.";
    } else {
      overallLabel = "Fixed Mindset Tendencies";
      overallColor = "#ef4444";
      overallDescription =
        "You are currently operating with a 'fixed' lens. You likely feel that you are being judged on your innate abilities, which makes everything feel high-stakes and scary. This mindset is the primary bottleneck on your career growth.";
    }
  ...
  hardworking: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Watch for over-investing in low-leverage tasks — effort without direction is still waste",
          "Ensure your high standards don't create unrealistic expectations of others",
        ],
        watchMid: [
          "Identify what conditions bring out your best effort and engineer more of them",
          "Build one non-negotiable daily work standard to anchor consistency",
        ],
        watchLow: [
          "Start with one commitment per day that you see through regardless of difficulty",
          "Examine what's driving the gap between your intentions and your follow-through",
        ],
      },
      {
        ...
        watchHigh: [
          "Audit your routines occasionally — discipline can calcify into rigidity",
          "Make space for rest; sustained output requires intentional recovery",
        ],
        watchMid: [
          "Choose one keystone habit and protect it for 30 days — consistency compounds",
          "Track your productive and unproductive days to identify patterns",
        ],
        watchLow: [
          "Focus on showing up, not performing — consistency starts before quality",
          "Remove friction from the start of your workday to lower the barrier to beginning",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't mistake depth for avoidance — ensure you're also responsive when it matters",
          "Review your priorities regularly; deep focus on the wrong thing is still a cost",
        ],
        watchMid: [
          "Implement a 'top 3 tasks' rule each morning before opening any inbox or app",
          "Block one 90-minute deep work session daily and treat it as non-negotiable",
        ],
        watchLow: [
          "Start by turning off all non-essential notifications for your first hour of work",
          "Ask yourself daily: 'What one thing, if done today, would make everything else easier?'",
        ],
      },
      {
        ...
        watchHigh: [
          "Persistence without reflection can become stubbornness — know when to pivot",
          "Ensure you're recovering, not just enduring — resilience needs replenishment",
        ],
        watchMid: [
          "Develop a personal protocol for setbacks: a specific ritual for how you re-engage",
          "Practice separating emotional reaction from professional response in the moment",
        ],
        watchLow: [
          "Reframe obstacles as expected features of meaningful work, not exceptions",
          "Build a track record of small comebacks — resilience is built through repetition",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure your internal drive accounts for rest — intrinsic motivation can mask burnout",
          "Revisit your purpose regularly; what drives you can shift as your life evolves",
        ],
        watchMid: [
          "Spend 20 minutes writing why this work matters to you beyond salary and status",
          "Connect daily tasks to a longer-term vision to fuel short-term discipline",
        ],
        watchLow: [
          "Explore what work has felt most meaningful in your life and look for the pattern",
          "External rewards are a starting point, not a destination — invest in finding your intrinsic why",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You demonstrate strong, consistent hardworking behaviours across all five dimensions. Your effort is deliberate, disciplined, and internally driven. You're not just busy — you're productive in ways that compound over time. The opportunity now is to sustain this without burning out, and to ensure your effort is always pointed at the highest-leverage work.";
    } else if (overall >= 50) {
      overallLabel = "Capable but Inconsistent";
      overallColor = "#f59e0b";
      overallDescription =
        "You have the raw ingredients of a hard worker — drive, standards, and resilience — but they don't yet fire reliably. Your output peaks when conditions are right and dips when they're not. The work ahead is about building systems that make your best self the default, not the exception.";
    } else {
      overallLabel = "Effort Gap Identified";
      overallColor = "#ef4444";
      overallDescription =
        "Your results point to a meaningful gap between your potential and your current work output. This isn't about intelligence or ability — it's about the habits, systems, and internal drive that convert potential into performance. The good news: hardworking is a behaviour, not a personality trait, and behaviours can be trained.";
    }
    ...
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Connection quality can decline if you stop investing in it — relationships need regular tending",
          "Ensure you're not confusing quantity of connections with depth — a few deep ones matter more than many shallow ones",
        ],
        watchMid: [
          "Identify one relationship worth deepening and invest in it deliberately over the next month",
          "Consider whether busyness, technology, or fear is creating distance in existing relationships",
        ],
        watchLow: [
          "Start small — one genuine conversation per week with someone you care about",
          "Consider whether a therapist, support group, or community activity could provide initial connection scaffolding",
        ],
      },
      {
        ...
        watchHigh: [
          "Intimacy requires vulnerability on both sides — ensure your close relationships have reciprocal depth",
          "Check in periodically: are you still allowing yourself to be known as you change and grow?",
        ],
        watchMid: [
          "Choose one trusted person and share something you haven't told anyone — small acts of vulnerability compound",
          "Ask yourself: what am I afraid would happen if people really knew me?",
        ],
        watchLow: [
          "The barrier to intimacy is almost always fear of rejection or judgment — naming this is the first step",
          "Therapy can be a safe space to practice being known before bringing it to personal relationships",
        ],
      },
      {
        ...
        watchHigh: [
          "Belonging can become a comfort zone — ensure it's not preventing you from expanding your world",
          "Examine whether your belonging comes at the cost of authenticity — real belonging accepts all of you",
        ],
        watchMid: [
          "Belonging is built through repeated genuine interaction — identify one community where you can show up consistently and authentically",
          "Consider whether you're presenting a curated version of yourself that makes belonging feel hollow",
        ],
        watchLow: [
          "Find one community built around something you genuinely care about — shared purpose creates belonging faster than shared proximity",
          "The feeling of being an outsider is often a story, not a fact — challenge it by showing up consistently",
        ],
      },
      {
        ...
        watchHigh: [
          "A rich inner life is an asset — ensure it doesn't become isolation disguised as self-sufficiency",
          "Loving yourself well includes knowing when you need others — don't let self-reliance become a wall",
        ],
        watchMid: [
          "Develop a solo practice you genuinely love — running, journaling, walking — that makes time with yourself feel good",
          "Notice when you reach for your phone or distraction to escape being with yourself — sit with it instead",
        ],
        watchLow: [
          "Therapy or self-inquiry work is particularly valuable here — the relationship with yourself is the root of everything",
          "Try 10 minutes of intentional solitude daily — not productivity, just being — and notice what arises",
        ],
      },
      {
        ...
        watchHigh: [
          "Please consider speaking to a mental health professional — loneliness at this level is a health issue, not just an emotional one",
          "Small consistent actions matter more than big ones — reach out to one person today, even briefly",
        ],
        watchMid: [
          "Don't wait for loneliness to worsen before acting — use this as a prompt to invest in one relationship or community",
          "Name what kind of connection you're most missing and take one step toward it this week",
        ],
        watchLow: [
          "Maintain your connection habits — wellbeing in this area is something to actively protect, not take for granted",
          "Consider whether there are people in your life who might be struggling and could benefit from your outreach",
        ],
      },
    ];
    ...
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Presence doesn't mean passivity — ensure your attentiveness also includes appropriate engagement and response",
          "Check that 'full presence' isn't being used to avoid contributing your own perspective when it's needed",
        ],
        watchMid: [
          "Before important conversations, take two slow breaths and consciously set an intention to listen",
          "Put your phone face-down and out of reach — physical removal of distraction is more effective than willpower",
        ],
        watchLow: [
          "Practice one conversation per day where you commit to zero internal agenda — just receive what's being said",
          "Notice when your mind is composing your response mid-sentence and gently return your focus to the speaker",
        ],
      },
      {
        name: "Comprehension",
        ...
        watchHigh: [
          "Strong comprehension can create overconfidence — always check your understanding rather than assuming you've got it",
          "Listen for what's changing in someone's thinking over time, not just what they're saying in this conversation",
        ],
        watchMid: [
          "After important conversations, write down the three key things the other person communicated — this builds comprehension muscle",
          "Ask one clarifying question per conversation as a practice — 'just to make sure I understand, are you saying...'",
        ],
        watchLow: [
          "Practice reflecting back what you've heard before responding: 'What I'm hearing is...' — it slows you down helpfully",
          "Read about active listening — even one resource deeply absorbed will create meaningful change",
        ],
      },
      {
        ...
        watchHigh: [
          "High attunement can mean you absorb others' emotions — develop boundaries that allow empathy without overwhelm",
          "Ensure you're responding to the person's actual emotional state and not projecting what you'd feel in their situation",
        ],
        watchMid: [
          "Ask 'how are you feeling about this?' more often than 'what do you think about this?' — it shifts the register",
          "Practice naming the emotion you sense someone is carrying: 'It sounds like you're frustrated' — even if quietly, to yourself",
        ],
        watchLow: [
          "Emotional attunement starts with curiosity — try to make it your practice to wonder how someone feels, not just what they mean",
          "Read 'I Hear You' by Michael Sorensen — it's a practical and accessible introduction to empathic listening",
        ],
      },
      {
        ...
        watchHigh: [
          "Excellent responses can set a high bar that others feel they can't match — be mindful of the dynamic your skill creates",
          "Don't let skill become performance — the goal is connection, not demonstrating listening technique",
        ],
        watchMid: [
          "Before responding, ask yourself: 'Does this response serve them or me?'",
          "Practise the pause — a two-second pause before speaking forces you to ensure your response comes from what you heard, not what you planned",
        ],
        watchLow: [
          "Replace 'That happened to me too...' with 'Tell me more about that' — this one habit shift will transform how people experience you",
          "Ask one question after someone finishes speaking, before offering any perspective — make it about them, not about you",
        ],
      },
      {
        ...
        watchHigh: [
          "Listening under pressure is a skill that requires maintenance — notice if certain topics or people still trigger a closure response",
          "Use your strong listening to model the behaviour for others in high-stakes conversations",
        ],
        watchMid: [
          "Before difficult conversations, set an explicit intention: 'I will listen to understand, not to respond'",
          "When you feel defensiveness rise, name it internally: 'I'm getting defensive' — this small act creates just enough space to keep listening",
        ],
        watchLow: [
          "Develop a physical anchor for calm in tense conversations — a slow breath, feet on the floor, hands relaxed",
          "Practice receiving feedback by asking for it from someone you trust and listening without any verbal response — just nod, absorb, and thank them",
        ],
      },
    ];
  ...
  attachment: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Comfort with closeness is an asset — ensure you're also allowing your partners and loved ones the space they need",
          "Reflect on whether you're equally comfortable with both giving and receiving emotional closeness",
        ],
        watchMid: [
          "Identify one specific way you keep people at a distance and experiment with removing that barrier in one relationship",
          "Consider what you're afraid of losing by being fully known — the answer often illuminates the work",
        ],
        watchLow: [
          "Therapy, particularly attachment-focused work, can be profoundly helpful here — this pattern has roots worth exploring",
          "Start with the smallest act of self-disclosure to someone you trust — vulnerability is built gradually, not all at once",
        ],
      },
      {
        name: "Anxiety & Fear",
        ...
        watchHigh: [
          "Anxious attachment is one of the most researched and treatable relational patterns — please consider working with a therapist",
          "Notice when you're seeking reassurance and try pausing before acting on the urge — the anxiety doesn't mean the fear is accurate",
        ],
        watchMid: [
          "Build your internal reassurance capacity — when anxiety spikes, ask: 'Is there actual evidence for this fear, or am I interpreting neutral information through an anxious lens?'",
          "Communicate your needs directly to people you trust rather than testing relationships indirectly",
        ],
        watchLow: [
          "Your security is an asset — use it to create safety for people in your life who carry more relational anxiety",
          "Notice if there are specific people or situations that do trigger more anxiety and explore why",
        ],
      },
      {
        ...
        watchHigh: [
          "Avoidant patterns often feel like strength (self-sufficiency, independence) but are often a protective response to early pain — exploring this with a therapist is valuable",
          "Practice identifying one emotional need per week and expressing it to someone safe — it gets easier with repetition",
        ],
        watchMid: [
          "Notice when you're pulling back and ask: 'Am I creating space because I need it, or because closeness is feeling threatening?'",
          "Practise staying emotionally present in conversations that make you want to withdraw",
        ],
        watchLow: [
          "Your openness to closeness is healthy — ensure you're also honouring your legitimate need for personal space and autonomy",
          "Being available for connection doesn't mean having no boundaries — reflect on whether yours are clear and communicated",
        ],
      },
      {
        ...
        watchHigh: [
          "Your willingness to engage in conflict can sometimes feel overwhelming to more avoidant partners — calibrate your approach to their pace",
          "Ensure that 'moving toward conflict' doesn't become forcing resolution before the other person is ready",
        ],
        watchMid: [
          "Identify your default conflict pattern (pursue, withdraw, explode, shut down) and work on the specific behaviour that follows from it",
          "The repair bid — a small gesture of reconnection after conflict — is one of the most powerful skills in relationship research. Practice it.",
        ],
        watchLow: [
          "Consider couples therapy or individual therapy focused on conflict patterns — this is highly learnable with the right support",
          "Start small: practice staying in one uncomfortable conversation for two minutes longer than you normally would before withdrawing",
        ],
      },
      {
        name: "Security & Trust",
        ...
        watchHigh: [
          "Secure attachment is hard-won — continue the practices that built it and don't take it for granted",
          "Use your security to be a source of stability and safety for people in your life who carry more fear",
        ],
        watchMid: [
          "Explore the specific narrative you carry about being lovable — often it's a story inherited from early experience, not an accurate reflection of reality",
          "Identify one person in your life who has shown up consistently for you and let that evidence counter the story that trust is unsafe",
        ],
        watchLow: [
          "Attachment-focused therapy (EFT, schema therapy, or relational therapy) is specifically designed for this work — it's worth the investment",
          "Begin practicing self-compassion — the relationship you have with yourself is the template for all other relationships",
        ],
      },
    ];
    ...
    const adjustedScores = sectionDefs.map((sec, i) => {
      const score = sectionScores[i];
      if (
        sec.name === "Anxiety & Fear" ||
        sec.name === "Avoidance & Distance"
      ) {
        return 100 - score;
      }
      return score;
    ...
    const sectionResults = sectionDefs.map((sec, i) => {
      ...
      const displayScore =
        sec.name === "Anxiety & Fear" || sec.name === "Avoidance & Distance"
          ? 100 - raw
          : raw;
      const tier =
        displayScore >= 70 ? "high" : displayScore >= 40 ? "mid" : "low";
      const color =
        displayScore >= 70
          ? "#10b981"
          : displayScore >= 40
  ...
  leadershipMindset: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Don't let optimism blind you to current performance gaps that need direct correction.",
          "Ensure you aren't over-investing in people who do not actually want to grow.",
        ],
        watchMid: [
          "Try delegating 'stretch goals' that are 10% beyond a person's current ability.",
          "Practice seeing failure as a diagnostic data point rather than a performance failure.",
        ],
        watchLow: [
          "Explore the 'Growth Mindset' framework for management.",
          "Shift your feedback from 'what you did wrong' to 'how you can evolve.'",
        ],
      },
      {
        name: "Risk Appetite",
        ...
        watchHigh: [
          "Ensure your team feels safe following you into the unknown; not everyone shares your risk tolerance.",
          "Balance your gut instincts with at least two hard metrics.",
        ],
        watchMid: [
          "Identify one 'Safe bet' you are holding onto and intentionally stress-test it.",
          "Practice making small, non-critical decisions faster to build your intuition.",
        ],
        watchLow: [
          "Understand that 'no decision' is actually a high-risk decision.",
          "Build a 'Risk Budget'—a small area where the team is allowed to fail without penalty.",
        ],
      },
      {
        name: "Trust & Default",
        ...
        watchHigh: [
          "Make sure you aren't abdicating responsibility when things go wrong.",
          "Verify that your high-trust doesn't turn into a lack of accountability.",
        ],
        watchMid: [
          "Identify one project this week to delegate 100%—including the final decision-making power.",
          "Ask more questions and give fewer answers in 1-on-1s.",
        ],
        watchLow: [
          "Ask yourself: 'Am I scaling the business or just scaling my own workload?'",
          "Evaluate how your constant oversight affects your team's initiative and morale.",
        ],
      },
      {
        name: "Success View",
        ...
        watchHigh: [
          "Don't sacrifice necessary results for the sake of harmony.",
          "Ensure your 'service' to the team doesn't lead to your own burnout.",
        ],
        watchMid: [
          "Re-align your daily tasks with your deeper 'Why' once a month.",
          "Celebrate small team wins as intentionally as you celebrate the big quarterly targets.",
        ],
        watchLow: [
          "Shift your internal narrative from 'I achieved' to 'We enabled'.",
          "Practice active listening to understand what success looks like for your team members.",
        ],
      },
    ];
    ...
    let overallLabel =
      overall >= 75
        ? "Empathetic Growth Leader"
        : overall >= 50
          ? "Balanced Pragmatist"
          : "Control-Oriented Traditionalist";
    ...
    return {
      ...
      overallLabel,
      overallColor: "#6366f1",
      overallDescription: "Analysis of your internal leadership blueprint.",
      sectionResults,
    };
  },
  ...
  leadershipOrientation: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Watch for team burnout; not everyone can maintain your 'sprint' pace forever.",
          "Make sure you don't confuse being 'busy' with being 'effective'.",
        ],
        watchMid: [
          "Use a more structured project management tool to visualize the finish line.",
          "Delegate one routine task today to reclaim one hour for strategic thinking.",
        ],
        watchLow: [
          "Connect your big ideas to a specific 'Tuesday morning' to-do list.",
          "Focus on closing open loops before starting new ones.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure your vision is grounded in current resource reality.",
          "Partner with a strong 'Operational' leader to land your big ideas.",
        ],
        watchMid: [
          "Write down your 3-year plan and share it with a peer to check for clarity.",
          "Block out 2 hours of 'Strategy Only' time on your calendar weekly.",
        ],
        watchLow: [
          "Read industry research for 30 minutes every morning before opening email.",
          "Ask: 'What will this decision look like in 12 months?' before acting.",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't let your empathy prevent you from holding people to high standards.",
          "Set clear performance boundaries early to avoid 'empathy traps.'",
        ],
        watchMid: [
          "Schedule non-negotiable 1-on-1s that focus ONLY on growth, not project updates.",
          "Practice asking for feedback from your team as much as you give it.",
        ],
        watchLow: [
          "Identify the career goals of your top 3 employees this week.",
          "Acknowledge great work publicly to build social capital.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure your systems don't become red-tape that kills agility.",
          "Be willing to break a process if it's no longer serving the goal.",
        ],
        watchMid: [
          "Document one key workflow this week that everyone uses.",
          "Look for one automation opportunity in your daily routine.",
        ],
        watchLow: [
          "Recognize that 'boring' work (SOPs) is what allows for 'exciting' growth.",
          "Pick the most repetitive mistake in your team and build a checklist to stop it.",
        ],
      },
    ];
    ...
    const sectionResults = sectionDefs.map((sec, i) => {
      ...
      const tier = score >= 70 ? "high" : score >= 40 ? "mid" : "low";
      const color =
        score >= 70 ? "#6366f1" : score >= 40 ? "#a855f7" : "#94a3b8";
      const watchKey = "watch" + tier.charAt(0).toUpperCase() + tier.slice(1);
      return {
        name: sec.name,
        score,
    ...
    return {
      overall,
      overallLabel: labels[primaryIdx],
      overallColor: "#6366f1",
      overallDescription: "Energy allocation analysis.",
      sectionResults,
    };
  },
  ...
  ambitionMindset: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Watch for 'Ambition Blindness'—don't neglect your health or relationships.",
          "Stay connected to who you are today.",
        ],
        watchMid: [
          "Identify which 20% of your goals are purely for 'status' and consider dropping them.",
          "Focus on the internal win.",
        ],
        watchLow: [
          "Find one activity you would do even if you could never tell anyone about it.",
          "Explore your deeper 'Why'.",
        ],
      },
      {
        ...
        watchHigh: [
          "Share your 'Failure Stories' with others to humanize your success.",
          "Don't stop doing thorough risk assessments.",
        ],
        watchMid: [
          "Practice the '15-minute vent'—vent after a failure, then pivot immediately to 'Lesson Mode'.",
          "Keep a Success Journal.",
        ],
        watchLow: [
          "Look at a failure from 2 years ago—what did it teach you?",
      ...
      },
      {
        ...
        watchHigh: [
          "Balance your 'future' self with your 'present' self.",
          "Ensure your vision includes well-being.",
        ],
        watchMid: [
          "Write a 'No-Limits' 5-year plan this week—ignore logic for 10 minutes.",
          "Question your definition of 'realistic.'",
        ],
        watchLow: [
          "Read biographies of people who started from zero.",
          "Spend 10 minutes a day visualizing success.",
        ],
      },
      {
        name: "Work Identity",
        ...
        watchHigh: [
          "Intentionally build an identity outside of work to prevent a crisis if work stalls.",
          "Mind your health.",
        ],
        watchMid: [
          "Ensure your restful activities are actually restful.",
          "Review your values annually.",
        ],
        watchLow: [
          "Connect your personal values to your professional output.",
          "Find a way to make work 'personal.'",
        ],
      },
    ];
    ...
    return {
      ...
      overallLabel,
      overallColor: "#f59e0b",
      overallDescription: "Psychological drive analysis.",
      sectionResults,
    };
  },
  ...
  ambitionOrientation: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Don't become so rigid with metrics that you miss unexpected opportunities.",
          "Ensure goals are values-aligned.",
        ],
        watchMid: [
          "Apply the SMART framework to your single most important goal today.",
          "Track metrics once a week.",
        ],
        watchLow: [
          "Write down one measurable goal for this month.",
          "Use a simple tracking app or a physical planner.",
        ],
      },
      {
        ...
        watchHigh: [
          "Make sure you aren't running in the wrong direction just to stay busy.",
          "Pause for strategy daily.",
        ],
        watchMid: [
          "Identify one thing you are 'waiting for permission' to do, and do it today.",
          "Analyze procrastination patterns.",
        ],
        watchLow: [
          "Find a 'bias-toward-action' partner.",
      ...
      },
      {
        ...
        watchHigh: [
          "Ensure you always have a 'downside protection' strategy.",
          "Don't bet everything on a single outcome.",
        ],
        watchMid: [
          "Identify one 'Safe bet' that is actually costing you opportunity.",
          "Calculate the 'Cost of Inaction'.",
        ],
        watchLow: [
          "Take one tiny social risk this week.",
          "Acknowledge that staying still is also a high-risk decision.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure you are giving as much value to your network as you take.",
          "Mentor someone junior.",
        ],
        watchMid: [
          "Reach out to one person who is 5 years ahead of you.",
          "Practice 'The Ask'—be direct.",
        ],
        watchLow: [
          "Join one professional community this month.",
          "Recognize that 'lone-wolfing' doesn't scale.",
        ],
      },
    ];
    ...
    return {
      ...
      overallLabel,
      overallColor: "#6366f1",
      overallDescription: "Pursuit mechanics analysis.",
      sectionResults,
    };
  },
  StressResilience: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Don't mistake calmness for immunity; check your physical health markers even when you feel fine.",
          "Ensure you aren't suppressing stress to the point of a future collapse.",
        ],
        watchMid: [
          "Practice 'body scanning' once a day to catch physical tension before it becomes a mood.",
          "Name your emotions out loud to reduce their power.",
        ],
        watchLow: [
          "Focus on 'Box Breathing' (4s in, 4s hold, 4s out, 4s hold) to manually reset your nervous system.",
          "Schedule 15 minutes of quiet time after every high-stakes interaction.",
        ],
      },
      {
        ...
        watchHigh: [
          "Keep diversifying your toolkit so your brain doesn't become 'numb' to one specific relief method.",
          "Share your tactics with your team.",
        ],
        watchMid: [
          "Set a 'Stress Trigger' alarm: if you feel a 7/10 stress, you MUST walk away for 5 minutes.",
          "Establish a clear boundary between 'Distraction' and 'Recovery'.",
        ],
        watchLow: [
          "Identify two small things (a song, a scent, a stretch) that make you feel 10% better.",
          "Practice saying 'I need a moment to think' instead of answering immediately.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure your optimism is grounded in reality; don't 'reframe' a situation that actually needs to be fixed.",
          "Help others reframe without sounding dismissive of their pain.",
        ],
        watchMid: [
          "Apply the '10-10-10' rule: will this matter in 10 minutes? 10 months? 10 years?",
          "Journal your 'Setback to Growth' history to remind yourself of your resilience.",
        ],
        watchLow: [
          "Write down the 3 facts of the situation and the 3 stories you are telling yourself about it.",
          "Stop using words like 'always', 'never', and 'disaster'.",
        ],
      },
      {
        ...
        watchHigh: [
          "Check in on your support system; ensure you are giving back as much emotional energy as you receive.",
          "Be specific about what kind of help you need (Listening vs. Solving).",
        ],
        watchMid: [
          "Practice 'low-stakes vulnerability'—share a small frustration with a peer this week.",
          "Recognize that asking for help is actually an act of competence, not failure.",
        ],
        watchLow: [
          "Identify one person who is a 'Calm Anchor' and spend 10 minutes with them when things get heavy.",
          "Join a community or peer group where high-stakes discussions are normalized.",
        ],
      },
      {
        ...
        watchHigh: [
          "Be careful not to become too rigid with your routines; maintain the ability to flex when life demands it.",
          "Review your boundaries quarterly as your responsibilities grow.",
        ],
        watchMid: [
          "Treat your rest like a meeting: put it on the calendar and don't cancel it.",
          "Identify your 'Yes-person' tendencies and practice saying 'I'll get back to you'.",
        ],
        watchLow: [
          "Audit your calendar: where can you add a 30-minute 'White Space' buffer every day?",
          "Commit to one non-negotiable sleep habit starting tonight.",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You have a highly developed internal architecture for handling pressure. You balance tactical relief with long-term prevention, allowing you to sustain high-stakes performance without compromising your well-being. The opportunity now is to model this for others and guard against complacency.";
    } else if (overall >= 45) {
      overallLabel = "Contextual Adapter";
      overallColor = "#f59e0b";
      overallDescription =
        "Your resilience is functional but fluctuates. You cope well in certain environments but may lose your 'center' when multiple areas of life get heavy at once. Strengthening your real-time regulation and proactive boundaries will move you toward an elite level of resilience.";
    } else {
      overallLabel = "High-Capacity Processor";
      overallColor = "#6366f1";
      overallDescription =
        "You feel the weight of life more acutely than most, which often indicates a high level of empathy and conscientiousness. However, your current 'Lone Wolf' approach and reactive habits are creating a bottleneck. Your path forward isn't about being 'tougher', but about building better scaffolding and systems to support your processing style.";
    }
  ...
  EgoProfile: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Ensure your openness doesn't turn into a lack of conviction; stand your ground when the data supports you.",
          "Model this 'Data-over-Ego' mindset for your peers.",
        ],
        watchMid: [
          "Practice 'Active Inquiry'—when criticized, ask two clarifying questions before explaining your position.",
          "Notice which specific people trigger your defensiveness.",
        ],
        watchLow: [
          "Ask 'What if they are 10% right?' as a mental exercise.",
          "Understand that a critique of a project is not a critique of your character.",
        ],
      },
      {
        name: "Idea Ownership",
        ...
        watchHigh: [
          "Be careful of abdicating your own voice too much; your unique perspective is still a vital asset.",
          "Highlight your team's contributions more often to build a collective shield.",
        ],
        watchMid: [
          "Practice supporting one plan this week that contradicts your original idea.",
          "Notice if you use 'I' more than 'We' when describing wins.",
        ],
        watchLow: [
          "Remind yourself: 'The goal is to win, not to be the person who found the way to win.'",
          "Try 'Blind Ideation' where you evaluate ideas without knowing the author.",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't become 'numb' to errors; ensure you are still conducting rigorous post-mortems.",
          "Help others feel safe failing by sharing your own 'Failure Resume.'",
        ],
        watchMid: [
          "Practice the 'Short Apology': admit the error, state the fix, and stop talking.",
          "Stop explaining the 'Why' unless specifically asked.",
        ],
        watchLow: [
          "Acknowledge one small mistake publicly this week to realize that people’s respect for you actually increases.",
          "Shift your identity from 'The Person who is never wrong' to 'The Person who learns the fastest.'",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure your 'Mastery' orientation doesn't make you appear aloof or disconnected from team goals.",
          "Use your stability to anchor others during competitive seasons.",
        ],
        watchMid: [
          "Unfollow social or professional feeds that trigger your 'Status Anxiety' response.",
          "Define your own 'Success Metrics' that don't involve other people.",
        ],
        watchLow: [
          "Celebrate a peer's win with a handwritten note or a public shout-out to break the comparison loop.",
          "Recognize that someone else's success is not your failure.",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You have successfully decoupled your identity from your output. By keeping your 'Identity Shield' low, you absorb information, feedback, and lessons at a much higher rate than your peers. You are an asset in high-innovation environments where iteration is the key to success.";
    } else if (overall >= 45) {
      overallLabel = "Pragmatic Protector";
      overallColor = "#f59e0b";
      overallDescription =
        "You are balanced but situational. You protect your identity when you feel threatened or exposed, which can occasionally bottleneck your growth. Increasing your comfort with being 'wrong' in public will unlock your next level of professional potential.";
    } else {
      overallLabel = "High-Intensity Identity Shield";
      overallColor = "#6366f1";
      overallDescription =
        "You spend significant cognitive energy defending your current self. While this makes you look confident, it is acting as a ceiling on your growth. True confidence isn't having all the answers; it's being the person most comfortable saying 'I don't know yet, but I will find out.'";
    }
  ...
  HarmonyVsImpactQuotient: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Check your tone; ensure that your directness isn't perceived as unnecessary aggression.",
          "Leave space for others to process the truth before moving to the solution.",
        ],
        watchMid: [
          "Practice 'Radical Candor': care personally, but challenge directly.",
          "Stop using 'softener' phrases like 'Maybe I'm wrong but...' or 'Just a thought...'",
        ],
        watchLow: [
          "Identify one 'unspoken truth' this week and state it in a meeting.",
          "Acknowledge that conflict is a sign of respect—you care enough about the person to give them the truth.",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't become aloof; ensure you are still connected to the social reality of your group.",
          "Check that you aren't ignoring legitimate social data in favor of 'Lone Wolf' logic.",
        ],
        watchMid: [
          "Do one thing today that you know someone will slightly dislike, just to practice being okay with it.",
          "Notice when you 'Mirror' the person you are talking to.",
        ],
        watchLow: [
          "Limit your 'Opinion Polls.' When making a personal choice, ask only one trusted source instead of five.",
          "Recognize that 'Being Liked' is a byproduct of high-impact work, not the goal itself.",
        ],
      },
      {
        ...
        watchHigh: [
          "Explain the 'Why' behind your boundaries so they are seen as protective, not restrictive.",
          "Teach your boundary logic to your team.",
        ],
        watchMid: [
          "Practice the '24-hour delay.' If a request is made, say 'Let me check my calendar and get back to you' as a default.",
          "Establish a hard stop time for work.",
        ],
        watchLow: [
          "Stop providing a long list of excuses when you say no. 'I don't have the bandwidth for this right now' is a full sentence.",
          "Delete work apps for the weekend.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure you are building 'Collective Ownership' so the team doesn't feel like you are a dictator.",
          "Check in on your blind spots.",
        ],
        watchMid: [
          "Make one solo decision today without checking with a peer first.",
          "Ask yourself: 'If the group hates this, would I still believe it's the right call?'",
        ],
        watchLow: [
          "Identify one project that you will take 100% responsibility for—the win and the loss.",
          "Practice stating your opinion *first* in a meeting instead of waiting to see what others say.",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You prioritize systemic value over social safety. While you may occasionally create social friction, you are the person who actually lands the mission. You are most effective in high-stakes turnaround environments where clear truth is required.";
    } else if (overall >= 45) {
      overallLabel = "Harmony-Oriented Professional";
      overallColor = "#f59e0b";
      overallDescription =
        "You are a 'Social Stabilizer.' You maintain the peace and build rapport easily. However, you are likely trading some of your personal impact for the sake of being well-liked. Hardening your boundaries will significantly increase your ROI.";
    } else {
      overallLabel = "Harmony Stabilizer";
      overallColor = "#d946ef";
      overallDescription =
        "Your current priority is social safety. You are a natural bridge-builder and highly empathetic. However, your 'Harmony Default' is likely causing you to over-function for others and avoid the hard decisions required for your own growth. You deserve to take up more space.";
    }
  ...
  perfectionism_index: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Watch for 'Sloppiness' in high-stakes tasks where precision actually matters.",
          "Ensure your speed doesn't leave your team behind.",
        ],
        watchMid: [
          "Set a 'Hard Ship' time: once the clock hits the hour, you MUST send the version you have.",
          "Identify your 'Diminishing Returns' threshold.",
        ],
        watchLow: [
          "Practice 'Imperfect Shipping'—send one email or draft today that is only 80% polished.",
          "Acknowledge that 'Perfect' is often a mask for the fear of being judged.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure your tolerance for errors doesn't lead to a drop in overall standards.",
          "Model resilience for your team when things go wrong.",
        ],
        watchMid: [
          "Celebrate the 90% that went right before you obsess over the 10% that went wrong.",
          "Keep a 'Win Log' to read when a mistake triggers you.",
        ],
        watchLow: [
          "Ask: 'Will this error matter in one year?' If no, limit your rumination to 5 minutes.",
          "Separate your identity from your latest result.",
        ],
      },
      {
        ...
        watchHigh: [
          "Document your 'Result-oriented' successes so they are repeatable.",
          "Be careful not to appear 'Chaotic' to your structured peers.",
        ],
        watchMid: [
          "Identify one task this week where you will delegate the outcome, but NOT specify the steps.",
          "Try one new tool or method just to break your pattern.",
        ],
        watchLow: [
          "Recognize that 'Boring' work (SOPs) is what allows for 'Exciting' growth.",
          "Build a checklist for the *results*, not the actions.",
        ],
      },
      {
        ...
        watchHigh: [
          "Continue to monitor your recovery markers.",
          "Ensure your standards are inclusive of your team's different processing speeds.",
        ],
        watchMid: [
          "Define what 'Success' looks like *before* you start the task.",
          "Practice 'Calibrated Standards'—not every task deserves an A+ effort.",
        ],
        watchLow: [
          "Schedule non-negotiable rest as if it were a high-stakes meeting.",
          "Read about the 'Pareto Principle' (80/20 rule).",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You are a master of high-quality action. You know exactly how to calibrate your effort to the stakes of the task, allowing you to ship high volumes of work without burning out. You are a natural builder who thrives in fast-paced environments.";
    } else if (overall >= 45) {
      overallLabel = "High-Standard Specialist";
      overallColor = "#f59e0b";
      overallDescription =
        "You are a precision player. Your work is reliable and high-quality. However, your perfectionism is currently acting as a speed-limiter. By learning to 'Ship early and iterate,' you can double your impact without working more hours.";
    } else {
      overallLabel = "High-Precision Architect";
      overallColor = "#6366f1";
      overallDescription =
        "You have an elite eye for detail and a deep sense of responsibility. Currently, however, your 'Outcome Protection' is creating a massive bottleneck. You are over-engineering tasks that don't deserve the bandwidth. Learn to distinguish between 'Heart Surgery' tasks (Zero errors allowed) and 'Postcard' tasks (Speed is the only metric).";
    }
  ...
  ProcrastinationBlueprint: (answers) => {
    const sectionDefs = [
      {
        ...
        watchHigh: [
          "Make sure your 'Starting' isn't actually 'Rushing.' Pause for 10% more planning time.",
          "Ensure you are finishing as well as you are starting.",
        ],
        watchMid: [
          "Use the '5-Minute Rule': Commit to doing the hard task for only 5 minutes. Usually, the momentum carries you through.",
          "Notice which environments lower your threshold (e.g., library vs home).",
        ],
        watchLow: [
          "Write down the absolute smallest first step (e.g., 'Open the document').",
          "Remove the 'Activation Friction'—set up your tools the night before.",
        ],
      },
      {
        ...
        watchHigh: [
          "Ensure you are communicating enough clarity to the more structured people on your team.",
          "Check that you aren't ignoring 'Weak Signals' because you are moving too fast.",
        ],
        watchMid: [
          "Practice 'Drafting'—tell yourself 'This is a trash version' to lower the pressure of getting the plan right.",
          "Set a time-limit for research.",
        ],
        watchLow: [
          "Recognize that 'Gathering more information' is often a stalling tactic.",
          "Write down your 3 biggest questions and seek answers to ONLY those today.",
        ],
      },
      {
        ...
        watchHigh: [
          "Don't forget to schedule intentional dopamine breaks; willpower is a depletable resource.",
          "Reward yourself for finishing a 'Heavy' task.",
        ],
        watchMid: [
          "Identify one 'Hard Win' to do first thing every Tuesday.",
          "Use a 'Focus Timer' to gamify your deep work.",
        ],
        watchLow: [
          "Put your phone in another room during your deep work block.",
          "Ask: 'What task am I avoiding most right now?' Do that for 10 minutes immediately.",
        ],
      },
      {
        ...
        watchHigh: [
          "Make sure you are celebrating the finish before diving into the next project.",
          "Model this 'Closing' behavior for your more reflective peers.",
        ],
        watchMid: [
          "Identify why the 'Final 5%' feels scary or boring.",
          "Partner with an 'Executor' who can help you push through the admin details.",
        ],
        watchLow: [
          "Commit to finishing one 'Half-Started' project this week before you start anything new.",
          "Reduce the size of your projects; aim for small, daily 'Ships'.",
        ],
      },
    ];
    ...
    if (overall >= 75) {
      ...
      overallColor = "#10b981";
      overallDescription =
        "You move with a massive bias for action. You understand that momentum is the primary antidote to anxiety. You thrive in high-stakes environments where 'Ready, Fire, Aim' is the required pace.";
    } else if (overall >= 45) {
      overallLabel = "Reflective Action-Taker";
      overallColor = "#f59e0b";
      overallDescription =
        "You are a steady producer, but your 'Decision Architecture' is currently fragile. You lose significant bandwidth to ramp-up time and clarity-seeking. By lowering your 'Initiative Threshold,' you can double your output without more effort.";
    } else {
...
async function sendReportEmail() {
  ...
  if (!email || !email.includes("@")) {
    ...
    statusEl.textContent = "Enter valid email.";
    return;
  }
